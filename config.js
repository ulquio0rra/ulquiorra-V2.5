...
global.imagen6 = fs.readFileSync('./Menu2.png');
...
global.comienzo = '• • ◕◕════';
global.fin = '════◕◕ • •';
global.botdate = `*[ 📅 ] تـاريـخ:*  ${moment.tz('America/Mexico_City').format('DD/MM/YY')}`;
global.bottime = `*[ ⏳ ] سـاعـة:* ${moment.tz('America/Mexico_City').format('HH:mm:ss')}`;
